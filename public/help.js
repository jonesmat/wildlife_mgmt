  ...
  var HELP = {
    ...
    settings: {
      ...
      html:
        ...
        'routes, property photos, the season calendar, data export &amp; restore, and app info.</p>' +
        ...
        '<p><strong>Tips:</strong></p><ul>' +
        '<li><strong>Most important thing in the app:</strong> all data lives only in this browser — ' +
        'nothing is uploaded anywhere. Use <strong>Data Export &amp; Restore</strong> to download a ' +
        'backup regularly; it’s your only copy if this device or browser profile is lost.</li>' +
        '<li>Moving to a new computer? Export here, then Restore on the new device.</li>' +
