...
(function() {
  ...
  var TOUR = {
    ...
    slides: [
      ...
      { icon: '📖', title: 'Stand on the shoulders of a giant',
        text: 'Good management is older than this app. Aldo Leopold — the father of wildlife management — named five tools for shaping land: the axe, the plow, the cow, fire, and the gun. They map almost perfectly onto today’s 1-d-1 qualifying practices.',
        points: ['A short, practical guide for the modern Texas land manager',
                 'See how each classic tool becomes an entry you log here'],
        link: { href: '/leopold', label: '📖 Read Leopold’s Five Tools' } },
